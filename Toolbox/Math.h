...
namespace Toolbox {
	...
	namespace Math {
		...
		template<typename PrecisionType = DEFAULT_PRECISION>
		PrecisionType AbsoluteValue(const PrecisionType Value) {
			return Value > 0 ? Value : -Value;
		}

		/** Adds the given numbers together. */
		template<typename PrecisionType = DEFAULT_PRECISION>
		PrecisionType Add(const PrecisionType Left, const PrecisionType Right) {
			return Left + Right;
		}
		...
		/** Subtracts the given numbers together. */
		template<typename PrecisionType = DEFAULT_PRECISION>
		PrecisionType Subtract(const PrecisionType Left, const PrecisionType Right) {
			return Left - Right;
		}
		...
		template<typename PrecisionType = DEFAULT_PRECISION>
		PrecisionType Multiply(const PrecisionType Left, const PrecisionType Right) {
			return Left * Right;
		}
		...
		/** Divides the given numbers together. */
		template<typename PrecisionType = DEFAULT_PRECISION>
		PrecisionType Divide(const PrecisionType Left, const PrecisionType Right) {
			return Left / Right;
		}
